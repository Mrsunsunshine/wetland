...
export default class Banner extends Component {
    ...
    renderBanner() {
        ...
        for (let i in this.props.bannerList) {
            arr.push(<TouchableOpacity style={styles.container} key={i}  onPress={()=>{alert(i)}}><Image key={i} style={styles.imageStyle} source={this.props.bannerList[i]}/></TouchableOpacity>);
        }
        return arr;
    }
